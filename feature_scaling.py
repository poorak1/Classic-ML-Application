...
X_train_noob = np.array([[1.24e+03, 3.00e+00, 1.00e+00, 6.40e+01],
...
X_train=z_scoreNorm(X_train_noob)
...
def gradient_descent(model_result, gradient, cost, w, b, x, y, alpha, iterations):
    ...
    for i in range(iterations):
        ...
        if((i%10)==0):
            print("Cost in iteration number",i,"is:", cost(model_result, x, y, w_tmp, b_tmp))
    return w_tmp, b_tmp
